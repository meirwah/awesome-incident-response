...
* [CORTEX](https://github.com/fatcrapinmybutt/cortex-osint) - Offline desktop intelligence platform that scans local files and builds interactive D3.js knowledge graphs by extracting entities, IOCs, and evidence chains from unstructured documents.
