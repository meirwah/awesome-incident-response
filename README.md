...
* [What Broke Today](https://whatbroke.today/) - AI-powered outage aggregator tracking 100+ cloud services (AWS, Azure, GCP, GitHub, Cloudflare) with real-time Telegram alerts, RSS feed, and JSON API.
