...
* [Sandia Cyber Omni Tracker (SCOT)](https://github.com/sandialabs/scot4) - Incident Response collaboration and knowledge capture tool focused on flexibility and ease of use. Our goal is to add value to the incident response process without burdening the user.
