...
* [Sandfly Security](https://www.sandflysecurity.com) - Agentless Linux intrusion detection and incident response platform. Automatically searches for signs of compromise and includes a variety of modules for forensics and incident response exclusively for Linux.
