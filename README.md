...
* [SOC-Copilot](https://github.com/G4rb3n/SOC-Copilot) - AI-powered SOC assistant for intelligent alert triage, investigation, and automated incident response. Self-learning system that generates rules and scripts from analysis results.
