...
* [InnerWarden](https://github.com/InnerWarden/innerwarden) - Autonomous security agent for Linux with real-time threat detection and automated incident response using 38 eBPF kernel hooks. Written in Rust.
