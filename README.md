...
* [DFIR Platform](https://platform.dfir-lab.ch) - API-first incident response toolkit with phishing email analysis, exposure scanning, IOC enrichment, and AI-powered triage. Credit-based pricing with a free tier. Also available as a CLI tool (`dfir-cli`).
